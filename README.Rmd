...
| Software paper | Chen I, Shi Q, Zeger SL, Wu Z (2022+) `baker`: An `R` package for Nested Partially-Latent Class Models. `r badge_custom("vignette", "software paper", "blue", "https://zhenkewu.com/assets/html/baker_vignette.html")`|
