...
| nested pLCM regression               | Wu, Z., Chen, I (2020). Probabilistic Cause-of-disease Assignment using Case-control Diagnostic Tests: A Hierarchical Bayesian Approach. *Statistics in Medicine*. [![](https://img.shields.io/badge/doi-10.1101/672808-yellow.svg)](https://doi.org/10.1101/672808)                                                                                                                                                                                                                                                                                                                                                                                                                                                |
...
| Software paper                       | Chen I, Shi Q, Zeger SL, Wu Z (2022+) `baker`: An `R` package for Nested Partially-Latent Class Models. [![](https://img.shields.io/badge/vignette-software%20paper-blue.svg)](https://zhenkewu.com/assets/html/baker_vignette.html)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
