...
regression model with nested subclasses; called by
...
- FPR_formula:
  ...
  False positive regression formula for slice s of BrS data. Check
  `model_options$likelihood$FPR_formula[[s]]`.
