...
If running JAGS on windows, please go to control panel to add the
directory to jags into ENVIRONMENTAL VARIABLE!

## See also

[write_model_NoReg](https://zhenkewu.com/baker/reference/write_model_NoReg.md)
for automatically generate `.bug` model file; This present function
store it in location: `mcmc_options$bugsmodel.dir`.
