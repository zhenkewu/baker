---
title: "Vignettes for baker: An R package for fitting nested partially latent class model to estimate disease etiologies"
author: "Zhenke Wu"
...
```{r trysel,fig.height=10, fig.width=10, eval=FALSE}
...
```{r dodod,fig.height=10, fig.width=10, eval=FALSE}
plot_group_etiology(
  result_folder,
