...
This is not working, changes to robCompositions?
```{r trysel,fig=FALSE,eval=FALSE}
...
```{r dodod,fig=FALSE}
#system(paste("cp pathogen_category_simulation.csv", file.path(working_dir,"pathogen_category_simulation.csv")))

## PROBLEM WITH robCompositions, VJC Feb 16 2017
#plot_group_etiology(result_folder,dir_taxo = global_patho_taxo_dir)
```
